  ...
  // Science Stream Courses
  {
    ...
    careerPaths: [
      ...
      },
      {
        ...
        growthRate: '32%',
        skills: ['Security Protocols', 'Ethical Hacking', 'Risk Assessment']
      },
      {
      ...
      },
      {
        ...
        description: 'Bridge development and IT operations',
        growthRate: '25%',
        skills: ['CI/CD', 'Automation', 'Containerization']
      },
      {
        title: 'Game Developer',
        description: 'Create video games and interactive media',
        growthRate: '18%',
        skills: ['Unity/Unreal', '3D Modeling', 'Game Physics']
      },
      {
        title: 'Full Stack Developer',
        description: 'Develop the front-end and back-end of web applications',
        growthRate: '30%',
        skills: ['JavaScript', 'React/Angular', 'Node.js']
      },
      {
        title: 'Blockchain Developer',
        description: 'Design and develop blockchain-based systems',
        growthRate: '45%',
        skills: ['Blockchain Fundamentals', 'Smart Contracts', 'Cryptocurrency']
      },
      {
        title: 'Network Architect',
        description: 'Design and build computer networks',
        growthRate: '20%',
        skills: ['Networking Fundamentals', 'Network Security', 'Cloud Networking']
      },
      {
      ...
      },
      {
        ...
        description: 'Oversee IT projects and teams',
        growthRate: '18%',
